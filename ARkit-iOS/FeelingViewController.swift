...
class FeelingViewController: UIViewController {
    ...
    private let feelingButtonConfigs: [FeelingButton] = [
        FeelingButton(title: "Good", iconName: "face.smiling", backgroundColor: UIColor(red: 0.20, green: 0.78, blue: 0.35, alpha: 1.0), textColor: .black, speechText: "Good"),
        FeelingButton(title: "Pain", iconName: "face.dashed", backgroundColor: UIColor(red: 1.0, green: 0.23, blue: 0.19, alpha: 1.0), textColor: .black, speechText: "Pain"),
        FeelingButton(title: "Thirsty", iconName: "drop.fill", backgroundColor: UIColor(red: 0.20, green: 0.78, blue: 0.35, alpha: 1.0), textColor: .black, speechText: "Thirsty"),
        FeelingButton(title: "Hungry", iconName: "fork.knife", backgroundColor: UIColor(red: 1.0, green: 0.23, blue: 0.19, alpha: 1.0), textColor: .black, speechText: "Hungry"),
        FeelingButton(title: "Cold", iconName: "snowflake", backgroundColor: UIColor(red: 0.5, green: 0.8, blue: 1.0, alpha: 1.0), textColor: .black, speechText: "Cold"),
        FeelingButton(title: "hot", iconName: "flame.fill", backgroundColor: UIColor(red: 1.0, green: 0.5, blue: 0.0, alpha: 1.0), textColor: .black, speechText: "hot")
    ]
    ...
    override func viewDidLoad() {
        ...
        // Light cream background with subtle pattern (matching CommunicationViewController)
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        Logger.debug("=== FeelingViewController viewWillDisappear - STOPPING eye tracking and dwell ===")
    ...
    private func setupUI() {
        ...
        for config in feelingButtonConfigs {
            let button = createFeelingButton(with: config)
            buttonsContainer.addSubview(button)
            feelingButtons.append(button)
        }
    ...
    private func createFeelingButton(with config: FeelingButton) -> UIButton {
        ...
        // Set accessibility identifier for speech
        button.accessibilityIdentifier = "speak:\(config.speechText)"
    ...
    private func layoutButtons() {
        ...
        for (index, button) in feelingButtons.enumerated() {
    ...
    @objc private func backButtonTapped() {
        guard !isNavigating else {
            Logger.debug("Back navigation already in progress")
            return
        }
        isNavigating = true
    ...
    private func handleButtonAction(_ button: UIButton) {
        ...
        // This check is FIRST - before navigation checks
        ...
        // Handle Exit button or Back button (only non-speech buttons reach here)
...
extension FeelingViewController: EyeTrackerDelegate {
...
extension FeelingViewController: DwellDetectorDelegate {
    ...
    func dwellDetector(_ detector: DwellDetector, didCompleteDwellOn view: UIView) {
        ...
        guard self.viewIfLoaded?.window != nil else {
            Logger.debug("FeelingViewController: Ignoring dwell completion - view is not visible")
            return
        }
        ...
        // Ensure we have a button and it's one of our feeling buttons, back button, or exit button
        guard let button = view as? UIButton,
              feelingButtons.contains(button) || button === backButton || button === exitButton else {
...
extension FeelingViewController: ARSCNViewDelegate {
...
extension FeelingViewController: ARSessionDelegate {
